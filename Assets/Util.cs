...
public class Util    
{
    public static void SetupStartup(string short_name)
    {
        CreateShortcut(Environment.GetFolderPath(Environment.SpecialFolder.Startup), short_name, System.Diagnostics.Process.GetCurrentProcess().MainModule.FileName);
    }
